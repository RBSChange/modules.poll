...
class poll_ResponseService extends f_persistentdocument_DocumentService
{
	...
	protected function preUpdate($document, $parentNodeId = null)
	{
		...
		if (!is_null($parent->getVotes()) )
		{
			...
			{
				throw new IllegalOperationException(LocaleService::getInstance()->transBO('m.poll.document.response.update-impossible-because-votes'));
			}
		}
	}
	...
	protected function preDelete($document)
	{
		...
		if ( $parent->getVotes()!== 0 )
		{
			throw new IllegalOperationException(LocaleService::getInstance()->transBO('m.poll.document.response.delete-impossible-because-votes'));
		}
